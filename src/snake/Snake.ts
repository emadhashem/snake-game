...
export class Snake extends Particle implements Part {
  ...
  direction = 0;
  partImg: HTMLImageElement = new Image();
  ...
  constructor(
    ...
    super(x, y, game);
    this.partImg.src = "../../imgs/snake-up.png";
  }
  ...
  update(): void {
    if (this.game.keys.includes(SnakeInput.up)) {
      ...
      this.y += this.speedY;
      this.direction = 4;
      this.partImg.src = "../../imgs/snake-down.png";
    } else if (this.game.keys.includes(SnakeInput.left)) {
      this.x -= this.speedX;
      this.direction = 1;
      this.partImg.src = "../../imgs/snake-left.png";
    } else if (this.game.keys.includes(SnakeInput.right)) {
      this.x += this.speedX;
      this.direction = 3;
      this.partImg.src = "../../imgs/snake-right.png";
    }
